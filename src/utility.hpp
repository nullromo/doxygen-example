 ...
 *
 * This function multiplies a number times another number and returns the result
 * of those two numbers multiplied together. The result is the product of the
 * two numbers, and that is the value that is returned by this function.
 *
